...
class CB01 extends StatefulWidget {
  const CB01({Key? key}) : super(key: key);

  @override
  _CB01State createState() => _CB01State();
}

class _CB01State extends State<CB01> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      ...
      Future.delayed(Duration.zero, () {
        setState(() {
          futureStudents = fetchStudents('CB', '1', token);
        });
      });
    });
  }
