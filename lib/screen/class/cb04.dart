...
class CB04 extends StatefulWidget {
  const CB04({Key? key}) : super(key: key);

  @override
  _CB04State createState() => _CB04State();
}

class _CB04State extends State<CB04> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=CB&year=3');
