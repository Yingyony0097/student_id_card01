...
class ICT01 extends StatefulWidget {
  const ICT01({Key? key}) : super(key: key);

  @override
  _ICT01State createState() => _ICT01State();
}

class _ICT01State extends State<ICT01> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=ICT&year=1');
