...
class ICT03 extends StatefulWidget {
  const ICT03({Key? key}) : super(key: key);

  @override
  _ICT03State createState() => _ICT03State();
}

class _ICT03State extends State<ICT03> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=ICT&year=3');
