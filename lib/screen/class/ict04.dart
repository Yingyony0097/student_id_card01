...
class ICT04 extends StatefulWidget {
  const ICT04({Key? key}) : super(key: key);

  @override
  _ICT04State createState() => _ICT04State();
}

class _ICT04State extends State<ICT04> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=ICT&year=4');
