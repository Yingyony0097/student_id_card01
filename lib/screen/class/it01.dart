...
class IT01 extends StatefulWidget {
  const IT01({Key? key}) : super(key: key);

  @override
  _IT01State createState() => _IT01State();
}

class _IT01State extends State<IT01> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=IT&year=1');
