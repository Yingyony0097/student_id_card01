...
class IT02 extends StatefulWidget {
  const IT02({Key? key}) : super(key: key);

  @override
  _IT02State createState() => _IT02State();
}

class _IT02State extends State<IT02> {
  ...
  Future<List<Student>> fetchStudents() async {
    try {
      ...
      final response = await dio.get('http://192.168.0.193:8000/student/studentsyear?field_of_study=IT&year=2');
